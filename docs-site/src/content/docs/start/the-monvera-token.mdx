...
The only real contract is `0x7541…a6FF` on Robinhood Chain, and the only pool is the Virtuals link above. Anyone sending you a different address, a "presale", or a "migration" is a scammer. See [staying safe from scams](/safety/scams-and-support/).
</Aside>
