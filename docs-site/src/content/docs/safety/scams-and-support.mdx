...
- **A buy shows as settling.** Some fills arrive wrapped and unwrap in about 1 to 15 minutes. It is already bought, already yours, already counted in your balance. It just cannot be sold until it lands. Nothing is stuck.
- **The site shows a restricted page.** Monvera is not available everywhere; see [before you invest](/start/before-you-invest/).
