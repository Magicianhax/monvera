...
You can start from $1. Each company inside a plan needs about $11 because of the trading venue's minimum, so a plan spread across four names wants about $44 or more to be worth building. Leave a little headroom above the amount you intend to invest, since prices move between asking and confirming.
