...
The $MONVERA token is at `0x7541872e32Bb529d7FF11D6C59832269ce33a6FF`, on Robinhood Chain, not on Base. It is unrelated to the trading stack: no route above touches it, and it is not an investment product.
