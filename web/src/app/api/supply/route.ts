  ...
  return Response.json(
    {
      ...
      as_of: s.asOf,
      notes:
        "Circulating = total supply minus the contractually-locked Sniper Tax Buyback (12.9%) and Developer (7.7%) tranches, per the disclosed Virtuals vesting schedule; fully unlocked 13 Jul 2027.",
    },
    { headers: HEADERS },
  );
}
