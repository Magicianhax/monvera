...
import { colorStyleCss, ROUND_THEME_CSS, SOFT_THEME_CSS, DESKTOP_CSS } from "@/lib/colorStyles";
...
export function ColorStyleTag() {
  ...
  return (
    <style
      id="monvera-color"
      dangerouslySetInnerHTML={{ __html: colorStyleCss(colorStyle) + ROUND_THEME_CSS + SOFT_THEME_CSS + DESKTOP_CSS }}
    />
  );
}
