                    ...
                    <HoldingRow
                      ...
                      right={
                        <div style={{ textAlign: "right" }}>
                          ...
                          <div className="tnum" style={{ fontSize: 12, color: "var(--ink-2)", marginTop: 2 }}>
                            {hide ? DOTS : `${tokenQty(h.raw + (h.smartRaw ?? BigInt(0)), dec)} ${h.asset.symbol}`}
                          </div>
                          ...
                          {/* Grove-held shares live at the smart account, so they
                              are not sellable from here — say so rather than let
                              a sell fail later. */}
                          {!hide && (h.smartUsd ?? 0) > 0 && (
                            <div className="tnum" style={{ fontSize: 11.5, color: "var(--primary)", marginTop: 2 }}>
