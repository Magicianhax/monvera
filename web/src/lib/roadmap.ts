...
export const ROADMAP: RoadmapPhase[] = [
  {
    ...
    items: [
      ...
      { name: "Groves", note: "Curated, managed stock baskets bought whole into your own wallet. $0 entry, $0 management, the only fee is 10% of profit at exit; Vera keeps every deposit at the published weights until you leave. Titan Grove is live." },
