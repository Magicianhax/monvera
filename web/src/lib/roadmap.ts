...
export const ROADMAP: RoadmapPhase[] = [
  {
    ...
    items: [
      ...
      { name: "Groves", note: "Curated, managed stock baskets bought whole into your own wallet. $0 entry, $0 management, the only fee is 10% of profit at exit; Vera actively manages every deposit, setting each window's weights within 0.7–1.3× of the published ones. Titan Grove is live." },
