...
export const GROVES: GroveDef[] = [
  {
    ...
    category: "Values",
    components: [
      { symbol: "NVDA", weightBps: 1800, reason: "Largest AI chip designer; passes the sector and ratio screens." },
      { symbol: "MSFT", weightBps: 1700, reason: "Cash-rich software platform with low debt relative to its size." },
      { symbol: "AAPL", weightBps: 1600, reason: "Hardware and services giant; debt ratio is borderline and re-checked quarterly." },
      { symbol: "GOOGL", weightBps: 1150, reason: "Search and cloud; small impure-income sliver flagged for purification." },
      { symbol: "AMZN", weightBps: 1050, reason: "Commerce and cloud; impure income stays under the 5% line." },
      { symbol: "META", weightBps: 850, reason: "Ad platform; clean on the ratio screens, impure sliver flagged." },
      { symbol: "TSM", weightBps: 630, reason: "The world's contract chip manufacturer, on a conservative balance sheet." },
      { symbol: "TSLA", weightBps: 520, reason: "Passes the screens; its volatility is priced into the small weight." },
    ...
    excluded: [
      ...
      { symbol: "QCOM", why: "Passes the screens but has no two-way venue route right now — returns when it can be both bought and sold." },
      { symbol: "AMAT", why: "Passes the screens but has no two-way venue route right now — returns when it can be both bought and sold." },
  ...
  },
  {
    ...
    category: "Sector",
    components: [
      { symbol: "NVDA", weightBps: 2250, reason: "The AI accelerator standard; the demand center of the whole basket." },
      { symbol: "TSM", weightBps: 1950, reason: "Manufactures nearly every advanced chip in this basket." },
      { symbol: "ASML", weightBps: 1650, reason: "EUV lithography monopoly — no ASML, no leading edge." },
      { symbol: "AMD", weightBps: 1500, reason: "The credible second source for AI accelerators." },
      { symbol: "MU", weightBps: 1200, reason: "Memory — HBM demand tracks the AI buildout directly." },
      { symbol: "PLTR", weightBps: 1050, reason: "The software layer selling AI to governments and enterprises." },
      { symbol: "LITE", weightBps: 400, reason: "Optical components for datacenter interconnect." },
    ],
    excluded: [
      ...
      { symbol: "SOXX", why: "No two-way venue route right now — returns when it can be both bought and sold." },
      { symbol: "AMAT", why: "No two-way venue route right now — returns when it can be both bought and sold." },
      { symbol: "QCOM", why: "No two-way venue route right now — returns when it can be both bought and sold." },
      { symbol: "SMCI", why: "No two-way venue route right now — returns when it can be both bought and sold." },
      { symbol: "GLW", why: "No two-way venue route right now — returns when it can be both bought and sold." },
    ],
    methodology:
  ...
  },
  {
    ...
    category: "Sector",
    components: [
      { symbol: "COIN", weightBps: 2950, reason: "The regulated US exchange — trading, custody, and a USDC revenue share." },
      { symbol: "CRCL", weightBps: 2650, reason: "Issues USDC and earns on the reserves behind it." },
      { symbol: "CLSK", weightBps: 2350, reason: "Bitcoin miner scaling US energy capacity." },
      { symbol: "APLD", weightBps: 2050, reason: "Datacenters built for HPC and AI tenants." },
    ],
    excluded: [
      ...
      { symbol: "IREN", why: "No two-way venue route right now — returns when it can be both bought and sold." },
      { symbol: "NBIS", why: "No two-way venue route right now — returns when it can be both bought and sold." },
    ],
    methodology:
